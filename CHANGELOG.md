...
## [0.11.0](https://github.com/SadeghHayeri/k8s-operator/compare/v0.10.18...v0.11.0) (2026-03-08)
...
* add auto-rollback on failed update with health check monitoring ([#75](https://github.com/SadeghHayeri/k8s-operator/issues/75)) ([1dff347](https://github.com/SadeghHayeri/k8s-operator/commit/1dff347ce46c8608be6a92640b9a5bf1bee53f28))
* add custom service ports and ingress backend port support ([#144](https://github.com/SadeghHayeri/k8s-operator/issues/144)) ([#145](https://github.com/SadeghHayeri/k8s-operator/issues/145)) ([d0604c1](https://github.com/SadeghHayeri/k8s-operator/commit/d0604c141889c37fb957c002ef7aeca7cecee10c))
* add first-class Ollama sidecar support ([860225e](https://github.com/SadeghHayeri/k8s-operator/commit/860225e8e656d228218056ed6be8937f897ba582))
* add HPA auto-scaling and Auto Pilot capability level ([#155](https://github.com/SadeghHayeri/k8s-operator/issues/155)) ([024e51a](https://github.com/SadeghHayeri/k8s-operator/commit/024e51aac294851ae0c9102d89c3ab38e9768d59))
* add Level 4 Deep Insights - auto-provisioned PrometheusRule and Grafana dashboards ([#149](https://github.com/SadeghHayeri/k8s-operator/issues/149)) ([3c46765](https://github.com/SadeghHayeri/k8s-operator/commit/3c46765f5e86a24ca904b58be1fce863cfdce4ff))
* add native Tailscale integration via CRD fields ([#115](https://github.com/SadeghHayeri/k8s-operator/issues/115)) ([c3a2ae4](https://github.com/SadeghHayeri/k8s-operator/commit/c3a2ae49b73836780aebb192fdfe931d445a1751))
* Add nautical banner image with crab captain at Kubernetes helm ([84d1854](https://github.com/SadeghHayeri/k8s-operator/commit/84d1854cb7200587d6745c9ae3dc29c049fc3b8e))
* add nginx gateway proxy sidecar for loopback-bound gateway ([#175](https://github.com/SadeghHayeri/k8s-operator/issues/175)) ([a52383b](https://github.com/SadeghHayeri/k8s-operator/commit/a52383b121de80229b1ae7b03622cd10561ac5a5))
* Add observability, testing, docs, and dev tooling ([5af27e1](https://github.com/SadeghHayeri/k8s-operator/commit/5af27e1884285d385356ee548f32a62dc8608a95))
* Add observability, testing, docs, and dev tooling for production readiness ([a8c063b](https://github.com/SadeghHayeri/k8s-operator/commit/a8c063b1e06143e06eacf84419ecbc31a9435684))
* add OpenClawSelfConfig CRD for agent self-modification ([#146](https://github.com/SadeghHayeri/k8s-operator/issues/146)) ([2351737](https://github.com/SadeghHayeri/k8s-operator/commit/235173750618afd32e64c571604c3bf753add2ef))
* add Operator SDK scorecard testing ([#198](https://github.com/SadeghHayeri/k8s-operator/issues/198)) ([3b44d9a](https://github.com/SadeghHayeri/k8s-operator/commit/3b44d9a4f4533988be44cca2f809ab70a2c93fc7))
* add opt-in auto-update for OCI registry version tracking ([#71](https://github.com/SadeghHayeri/k8s-operator/issues/71)) ([5ce624e](https://github.com/SadeghHayeri/k8s-operator/commit/5ce624e72e70a185700fced9b4cc6c2461d74b91))
* add performance benchmarks for resource builders ([#197](https://github.com/SadeghHayeri/k8s-operator/issues/197)) ([41efb29](https://github.com/SadeghHayeri/k8s-operator/commit/41efb29b1de83aa74520f06a6d0dd4483eb08dcc))
* add periodic scheduled backups via CronJob ([#207](https://github.com/SadeghHayeri/k8s-operator/issues/207)) ([bf29965](https://github.com/SadeghHayeri/k8s-operator/commit/bf299650b8aad631fdfa6c3427f414bda9b7d511))
* add Phase 2+3 features and CVE-2025-22868 fix ([#84](https://github.com/SadeghHayeri/k8s-operator/issues/84)) ([94d4273](https://github.com/SadeghHayeri/k8s-operator/commit/94d427300aece52946929d3360e612ebbdba8441))
* add read-only rootfs, config merge mode, skill installation, and secret rotation detection ([#82](https://github.com/SadeghHayeri/k8s-operator/issues/82)) ([abd7911](https://github.com/SadeghHayeri/k8s-operator/commit/abd7911b76c829127c133d251927f5862f3cdeda))
* add runtime dependency init containers for pnpm and Python/uv ([#89](https://github.com/SadeghHayeri/k8s-operator/issues/89)) ([#90](https://github.com/SadeghHayeri/k8s-operator/issues/90)) ([b6a583c](https://github.com/SadeghHayeri/k8s-operator/commit/b6a583cfa368a49d0054943b5f055e925c2c2e5e))
* Add support for custom sidecar containers ([#27](https://github.com/SadeghHayeri/k8s-operator/issues/27)) ([f0071f7](https://github.com/SadeghHayeri/k8s-operator/commit/f0071f72dd92b248223f53b7af9b2f3eb9a184be)), closes [#24](https://github.com/SadeghHayeri/k8s-operator/issues/24)
* add Tailscale sidecar for working tailnet integration ([#177](https://github.com/SadeghHayeri/k8s-operator/issues/177)) ([d956925](https://github.com/SadeghHayeri/k8s-operator/commit/d956925bb60437aa67ff82f961228933e286e0fc))
* add topology spread constraints support ([#196](https://github.com/SadeghHayeri/k8s-operator/issues/196)) ([98ba176](https://github.com/SadeghHayeri/k8s-operator/commit/98ba176822bc72e1a27497ab66f122715ac024fc))
* add ttyd web terminal managed sidecar ([#159](https://github.com/SadeghHayeri/k8s-operator/issues/159)) ([a9e1bce](https://github.com/SadeghHayeri/k8s-operator/commit/a9e1bceb9897391cdf75459c6b4beaddce64c201))
* add webhook warning for latest image tag ([#67](https://github.com/SadeghHayeri/k8s-operator/issues/67)) ([6791624](https://github.com/SadeghHayeri/k8s-operator/commit/6791624d8ec5e46fc95b02f125ac38b1578a30c7))
* add workflow_dispatch trigger for manual OperatorHub submissions ([#51](https://github.com/SadeghHayeri/k8s-operator/issues/51)) ([f53bc58](https://github.com/SadeghHayeri/k8s-operator/commit/f53bc583f00c96603f4a437eeeabb393c15f5ca5))
* auto-generate gateway token auth for OpenClaw instances ([#85](https://github.com/SadeghHayeri/k8s-operator/issues/85)) ([6ee7eca](https://github.com/SadeghHayeri/k8s-operator/commit/6ee7eca5002b7035f15e1042a18d6199e50823c1)), closes [#83](https://github.com/SadeghHayeri/k8s-operator/issues/83)
* **chromium:** add extraArgs and extraEnv fields to ChromiumSpec ([#187](https://github.com/SadeghHayeri/k8s-operator/issues/187)) ([2878482](https://github.com/SadeghHayeri/k8s-operator/commit/2878482029cf0d4f4f4976cacbb594c66bb8a339))
* **chromium:** add extraArgs/extraEnv to ChromiumSpec, fix issues [#189](https://github.com/SadeghHayeri/k8s-operator/issues/189)-[#193](https://github.com/SadeghHayeri/k8s-operator/issues/193) ([#194](https://github.com/SadeghHayeri/k8s-operator/issues/194)) ([cba8d1a](https://github.com/SadeghHayeri/k8s-operator/commit/cba8d1a66c972a434d182fd80e815a44e6e79990))
* GitHub-based skill pack resolution ([#218](https://github.com/SadeghHayeri/k8s-operator/issues/218)) ([077dfa6](https://github.com/SadeghHayeri/k8s-operator/commit/077dfa6b52ec71c312a1e9338788b331d2cfd27a))
* improve OperatorHub and ArtifactHub listing quality ([#142](https://github.com/SadeghHayeri/k8s-operator/issues/142)) ([b15937c](https://github.com/SadeghHayeri/k8s-operator/commit/b15937c87da175cf72f1b7981c6bcef1b8330bfe))
* Initial OpenClaw Kubernetes Operator implementation ([6d873ff](https://github.com/SadeghHayeri/k8s-operator/commit/6d873ff855273c9e51337181e657ced2b82af711))
* Inject CHROMIUM_URL env var into main container when sidecar is enabled ([8553cc7](https://github.com/SadeghHayeri/k8s-operator/commit/8553cc7ec0b41675bd815a0f8febd0622bbf068c))
* Inject CHROMIUM_URL env var when sidecar is enabled ([b80dabe](https://github.com/SadeghHayeri/k8s-operator/commit/b80dabe32dbf2ff0f755c92f4e83e2467050bd89))
* migrate workload from Deployment to StatefulSet ([145e6ba](https://github.com/SadeghHayeri/k8s-operator/commit/145e6babc08704ba376752208926558d801e05c4))
* migrate workload from Deployment to StatefulSet ([6e3d491](https://github.com/SadeghHayeri/k8s-operator/commit/6e3d49106f228920e2d0621695dbb7046e4bced6))
* native workspace file seeding via CRD spec ([#58](https://github.com/SadeghHayeri/k8s-operator/issues/58)) ([de06c4a](https://github.com/SadeghHayeri/k8s-operator/commit/de06c4a618ad912f79deffc5f2fd1cb102cb4a42))
* PVC backup-on-delete and restore-from-backup ([#60](https://github.com/SadeghHayeri/k8s-operator/issues/60)) ([d49fb1a](https://github.com/SadeghHayeri/k8s-operator/commit/d49fb1a5152dedc47ffede4092b6bd903546aca4))
* rename B2/Backblaze to generic S3-compatible storage ([#157](https://github.com/SadeghHayeri/k8s-operator/issues/157)) ([df76683](https://github.com/SadeghHayeri/k8s-operator/commit/df766839d6fdef920dd85960e46f6a4d2299bc9f))
* Replace manual release steps with GoReleaser ([#2](https://github.com/SadeghHayeri/k8s-operator/issues/2)) ([fedc497](https://github.com/SadeghHayeri/k8s-operator/commit/fedc49766d414e0a2d96bc9c080abcb82b2b2202))
* run main container as root to allow custom tool installation ([e8e6f1f](https://github.com/SadeghHayeri/k8s-operator/commit/e8e6f1fcf0a61545185e30191e01b6a1443b1b06))
* Support custom egress rules in NetworkPolicy ([#15](https://github.com/SadeghHayeri/k8s-operator/issues/15)) ([#16](https://github.com/SadeghHayeri/k8s-operator/issues/16)) ([c62dc09](https://github.com/SadeghHayeri/k8s-operator/commit/c62dc09cec6112cf4625175423d033310ce50dc3))
* support npm packages in skills field and disable lifecycle scripts ([#137](https://github.com/SadeghHayeri/k8s-operator/issues/137)) ([a9db9d0](https://github.com/SadeghHayeri/k8s-operator/commit/a9db9d091a357bca07b260ed6e7f9560917f9e9d)), closes [#131](https://github.com/SadeghHayeri/k8s-operator/issues/131) [#91](https://github.com/SadeghHayeri/k8s-operator/issues/91)
* switch probes from exec to httpGet ([#231](https://github.com/SadeghHayeri/k8s-operator/issues/231)) ([d5b7754](https://github.com/SadeghHayeri/k8s-operator/commit/d5b7754400e3b1d3e41c57237b03aefc8bc76525))
* update banner with real OpenClaw logo and Kubernetes logo ([#37](https://github.com/SadeghHayeri/k8s-operator/issues/37)) ([840adb9](https://github.com/SadeghHayeri/k8s-operator/commit/840adb9e285c14dffe1bfed17e9b9411b05f4538))


### Bug Fixes

* add --force flag to clawhub install to prevent errors on existing dependencies ([266612c](https://github.com/SadeghHayeri/k8s-operator/commit/266612c9ec1c89784e4ebf78b414a6eb7220d279))
* add configurable timeout for BackingUp phase to prevent stuck instances ([#226](https://github.com/SadeghHayeri/k8s-operator/issues/226)) ([778a642](https://github.com/SadeghHayeri/k8s-operator/commit/778a6426d4f2b26845f110887b3bc41f02ceb0ac)), closes [#224](https://github.com/SadeghHayeri/k8s-operator/issues/224)
* Add leader election RBAC and E2E test infrastructure ([4eb6019](https://github.com/SadeghHayeri/k8s-operator/commit/4eb601994f3b87bde07f4c28a51f1dd010f045d4))
* add optional S3_REGION support for MinIO backups ([#212](https://github.com/SadeghHayeri/k8s-operator/issues/212)) ([c5e96c8](https://github.com/SadeghHayeri/k8s-operator/commit/c5e96c89660566d5b35a137d8a098ca18cf51234)), closes [#205](https://github.com/SadeghHayeri/k8s-operator/issues/205)
* add skip-backup annotation to E2E test instance ([#69](https://github.com/SadeghHayeri/k8s-operator/issues/69)) ([33ab056](https://github.com/SadeghHayeri/k8s-operator/commit/33ab0563ebfdfb4817a8cd4627400af35ae3a699))
* Apply same CreateOrUpdate pattern to ServiceMonitor reconciler ([#30](https://github.com/SadeghHayeri/k8s-operator/issues/30)) ([c1aaa36](https://github.com/SadeghHayeri/k8s-operator/commit/c1aaa3639b7cb82eb95696bbe06b98817d46a55e))
* auto-label release PRs to prevent release-please stalling ([#80](https://github.com/SadeghHayeri/k8s-operator/issues/80)) ([c1bce0a](https://github.com/SadeghHayeri/k8s-operator/commit/c1bce0add378e1917c086c6c6e7f4779ac7f45af))
* auto-set gateway.bind=loopback and use exec probes for Tailscale serve/funnel ([#170](https://github.com/SadeghHayeri/k8s-operator/issues/170)) ([e26694b](https://github.com/SadeghHayeri/k8s-operator/commit/e26694b5bd38d7bd4a286f1e6caf5d3438bf6366)), closes [#167](https://github.com/SadeghHayeri/k8s-operator/issues/167)
* break reconciliation tight loop caused by unconditional status writes ([#163](https://github.com/SadeghHayeri/k8s-operator/issues/163)) ([88921b7](https://github.com/SadeghHayeri/k8s-operator/commit/88921b7fafe3e703441030d49885dc3277c61213)), closes [#161](https://github.com/SadeghHayeri/k8s-operator/issues/161)
* Bump chromium /dev/shm from 256Mi to 1Gi ([925d7b8](https://github.com/SadeghHayeri/k8s-operator/commit/925d7b84c0630b73f581fca32d8da68ca582cd19))
* Bump chromium /dev/shm sizeLimit from 256Mi to 1Gi ([a4b3fbb](https://github.com/SadeghHayeri/k8s-operator/commit/a4b3fbb005fd40a743a54dcb8ce42c0db9ef7b27))
* change CRD API group domain from openclaw.io to openclaw.rocks ([#41](https://github.com/SadeghHayeri/k8s-operator/issues/41)) ([5bae852](https://github.com/SadeghHayeri/k8s-operator/commit/5bae852810d249358fad1453694503298851208c))
* Chromium sidecar crash (UID mismatch + read-only rootfs) and lint ([#14](https://github.com/SadeghHayeri/k8s-operator/issues/14)) ([febe1d3](https://github.com/SadeghHayeri/k8s-operator/commit/febe1d323bb80e4ffc0e36721fa1cd75a949b023))
* **chromium:** pass extraArgs via DEFAULT_LAUNCH_ARGS env instead of container Args ([#211](https://github.com/SadeghHayeri/k8s-operator/issues/211)) ([ec79758](https://github.com/SadeghHayeri/k8s-operator/commit/ec797581aa068ebd48cb55c11de048f41024c826)), closes [#209](https://github.com/SadeghHayeri/k8s-operator/issues/209)
* configMapRef bypasses gateway auth enrichment ([#138](https://github.com/SadeghHayeri/k8s-operator/issues/138)) ([1322d5e](https://github.com/SadeghHayeri/k8s-operator/commit/1322d5e8e3141a9c5a4ea7298ddc0149d2a1d11c))
* configure git credential helper for OperatorHub push ([#54](https://github.com/SadeghHayeri/k8s-operator/issues/54)) ([ef8bb8f](https://github.com/SadeghHayeri/k8s-operator/commit/ef8bb8fe3698fc885b8ad9348b3f2b1b4d32ffae))
* configure git identity for OperatorHub submission commits ([#53](https://github.com/SadeghHayeri/k8s-operator/issues/53)) ([8b58876](https://github.com/SadeghHayeri/k8s-operator/commit/8b58876feb946c22c931b15ace69e6b2bfa85859))
* create operator directory for first-time OperatorHub submission ([#52](https://github.com/SadeghHayeri/k8s-operator/issues/52)) ([58faaca](https://github.com/SadeghHayeri/k8s-operator/commit/58faaca8b54fdee094686c8ece440392a82f964e))
* create release tag when skip-github-release is enabled ([#49](https://github.com/SadeghHayeri/k8s-operator/issues/49)) ([95ffd24](https://github.com/SadeghHayeri/k8s-operator/commit/95ffd2408a3e085bd60f522b1671387b8f81be98))
* Disable SBOM upload-release-assets to avoid race condition ([d909808](https://github.com/SadeghHayeri/k8s-operator/commit/d909808d5aecde367748691604be1fbc152a6619))
* Downgrade to Go 1.23 for golangci-lint compatibility ([dd33c08](https://github.com/SadeghHayeri/k8s-operator/commit/dd33c08d1ffe962f358c14a6ae0a7b3105799d44))
* emit provider-aware ingress annotations based on className ([#109](https://github.com/SadeghHayeri/k8s-operator/issues/109)) ([#110](https://github.com/SadeghHayeri/k8s-operator/issues/110)) ([c040df6](https://github.com/SadeghHayeri/k8s-operator/commit/c040df69f77e95ea8e284e84ad7bf86cd03df1ed))
* expose metrics port in Service, StatefulSet, and ServiceMonitor ([#169](https://github.com/SadeghHayeri/k8s-operator/issues/169)) ([049d097](https://github.com/SadeghHayeri/k8s-operator/commit/049d097d81a42493a224bf129a243162685b1e5d)), closes [#166](https://github.com/SadeghHayeri/k8s-operator/issues/166)
* extract imageTagLatest constant to satisfy goconst linter ([#68](https://github.com/SadeghHayeri/k8s-operator/issues/68)) ([fc14d1a](https://github.com/SadeghHayeri/k8s-operator/commit/fc14d1a12406373cf0fd5a6cf779e64594577841))
* force push OperatorHub branch for retry resilience ([#56](https://github.com/SadeghHayeri/k8s-operator/issues/56)) ([a18836f](https://github.com/SadeghHayeri/k8s-operator/commit/a18836f567294bf90d45b05848b9851f7ba7697c))
* graceful deletion when B2 backup credentials are not configured ([#112](https://github.com/SadeghHayeri/k8s-operator/issues/112)) ([10b59be](https://github.com/SadeghHayeri/k8s-operator/commit/10b59be0368d2f4c2ad5069621ecf62609d924eb)), closes [#111](https://github.com/SadeghHayeri/k8s-operator/issues/111)
* Increase golangci-lint timeout and update to v1.63.4 ([1d982ca](https://github.com/SadeghHayeri/k8s-operator/commit/1d982ca114f3316ad656bf873ad0fc6694f71cc5))
* inject browser config for Chromium sidecar ([#126](https://github.com/SadeghHayeri/k8s-operator/issues/126)) ([570344e](https://github.com/SadeghHayeri/k8s-operator/commit/570344e167702092bd7e5640d7c1aff0340e01e1))
* inject gateway.bind=lan so vanilla deployments pass health probes ([#102](https://github.com/SadeghHayeri/k8s-operator/issues/102)) ([7c63d86](https://github.com/SadeghHayeri/k8s-operator/commit/7c63d862b7e09c1d44368205c915064d4dbe25e1)), closes [#101](https://github.com/SadeghHayeri/k8s-operator/issues/101)
* Link OpenClaw to openclaw.ai, not openclaw.rocks ([679b043](https://github.com/SadeghHayeri/k8s-operator/commit/679b04340afc6835284f2e9e13e7aef02e69ed14))
* Link OpenClaw to openclaw.ai, not openclaw.rocks ([#22](https://github.com/SadeghHayeri/k8s-operator/issues/22)) ([9bfdbd8](https://github.com/SadeghHayeri/k8s-operator/commit/9bfdbd86b29ed43f043a16bdbd126f6960df32a2))
* make OperatorHub workflow idempotent on re-runs ([#63](https://github.com/SadeghHayeri/k8s-operator/issues/63)) ([811e682](https://github.com/SadeghHayeri/k8s-operator/commit/811e682d0f03450ea04facef8e0d5de7a9eb745f))
* make Probes a pointer type to accept null/omitted values ([#181](https://github.com/SadeghHayeri/k8s-operator/issues/181)) ([df42069](https://github.com/SadeghHayeri/k8s-operator/commit/df42069191e451a756ced3b74faaed3cf44acab0)), closes [#179](https://github.com/SadeghHayeri/k8s-operator/issues/179)
* make skill pack resolution non-blocking to prevent provisioning failures ([#227](https://github.com/SadeghHayeri/k8s-operator/issues/227)) ([ffb2485](https://github.com/SadeghHayeri/k8s-operator/commit/ffb24852190e66844c9fe0f69ba28db8c9fade8f)), closes [#225](https://github.com/SadeghHayeri/k8s-operator/issues/225)
* move CRDs from Helm crds/ to templates/ for upgrade support ([#173](https://github.com/SadeghHayeri/k8s-operator/issues/173)) ([599b394](https://github.com/SadeghHayeri/k8s-operator/commit/599b39450a91a858e15d5ccf5f702db0c2c82392)), closes [#168](https://github.com/SadeghHayeri/k8s-operator/issues/168)
* Polish README copy and diagram alignment ([#19](https://github.com/SadeghHayeri/k8s-operator/issues/19)) ([ef6a8d1](https://github.com/SadeghHayeri/k8s-operator/commit/ef6a8d1f0973f36d3c790d34529f86e1c1d7343c))
* Pre-enable channel modules in config to prevent EBUSY on startup ([#13](https://github.com/SadeghHayeri/k8s-operator/issues/13)) ([21ee585](https://github.com/SadeghHayeri/k8s-operator/commit/21ee585fb4bef4f77afed0b0a8d730c0975af0e3)), closes [#11](https://github.com/SadeghHayeri/k8s-operator/issues/11)
* Prevent endless Deployment reconciliation loop ([#29](https://github.com/SadeghHayeri/k8s-operator/issues/29)) ([db942b9](https://github.com/SadeghHayeri/k8s-operator/commit/db942b945586e6c3b49db7f0d3ca242f5fac7b44)), closes [#28](https://github.com/SadeghHayeri/k8s-operator/issues/28)
* prevent StatefulSet reconciliation loop from server-side defaults ([#217](https://github.com/SadeghHayeri/k8s-operator/issues/217)) ([0617b46](https://github.com/SadeghHayeri/k8s-operator/commit/0617b46147cf6221ece0020b613ec8364ec8bc53))
* prevent StatefulSet spec drift on every reconcile ([#133](https://github.com/SadeghHayeri/k8s-operator/issues/133)) ([b6fa7b3](https://github.com/SadeghHayeri/k8s-operator/commit/b6fa7b3f257e51593fb01aaa42a8e4b89e9de50b))
* propagate nodeSelector and tolerations to backup/restore Jobs ([#221](https://github.com/SadeghHayeri/k8s-operator/issues/221)) ([342c7ae](https://github.com/SadeghHayeri/k8s-operator/commit/342c7ae032cad88b5f4e15009c2accca8fd1ddb6))
* Remove chart-releaser, keep OCI-only Helm distribution ([#3](https://github.com/SadeghHayeri/k8s-operator/issues/3)) ([99e3cdb](https://github.com/SadeghHayeri/k8s-operator/commit/99e3cdba598ac46e5cd3cab2dc7dad00b456a0e8))
* Replace config subPath mount with init container to avoid EBUSY ([#10](https://github.com/SadeghHayeri/k8s-operator/issues/10)) ([38b60d3](https://github.com/SadeghHayeri/k8s-operator/commit/38b60d39b835fb1eca459f6c4d612d0304873c3e)), closes [#9](https://github.com/SadeghHayeri/k8s-operator/issues/9)
* resolve chromium sidecar port conflict and unreachable CDP ([#183](https://github.com/SadeghHayeri/k8s-operator/issues/183)) ([2d3d212](https://github.com/SadeghHayeri/k8s-operator/commit/2d3d2127e6f2ee2566e748e993b5aceae22c80a4)), closes [#180](https://github.com/SadeghHayeri/k8s-operator/issues/180)
* resolve flaky backup/restore tests and autorelease label API ([#117](https://github.com/SadeghHayeri/k8s-operator/issues/117)) ([da7a2a5](https://github.com/SadeghHayeri/k8s-operator/commit/da7a2a58f0cb82bac091e954179efdd4827d2b78))
* Resolve variable shadowing of err in PVC reconciliation ([a9ea85b](https://github.com/SadeghHayeri/k8s-operator/commit/a9ea85b05770ba4123b4c0325e551ba93e90d103))
* restore config on container restart via postStart hook ([#128](https://github.com/SadeghHayeri/k8s-operator/issues/128)) ([38ea2c5](https://github.com/SadeghHayeri/k8s-operator/commit/38ea2c53adc1a4ba71bf307780b8c415d18fad6d))
* set CSV capabilities to Deep Insights (Level 4) ([#152](https://github.com/SadeghHayeri/k8s-operator/issues/152)) ([1fe72ed](https://github.com/SadeghHayeri/k8s-operator/commit/1fe72ed7369e3cc73255c7a6cde2dfb6ac841b39))
* Set HOME env var to match config mount path ([#5](https://github.com/SadeghHayeri/k8s-operator/issues/5)) ([175ff92](https://github.com/SadeghHayeri/k8s-operator/commit/175ff9219b5af8d80e37579627f8ebccce71cb1b)), closes [#4](https://github.com/SadeghHayeri/k8s-operator/issues/4)
* skip GitHub release creation in release-please ([#47](https://github.com/SadeghHayeri/k8s-operator/issues/47)) ([96a5be9](https://github.com/SadeghHayeri/k8s-operator/commit/96a5be93020ef61d6a37f804e1a741b3a229e86d))
* Specify kind cluster name for image loading ([7ac2116](https://github.com/SadeghHayeri/k8s-operator/commit/7ac21166b36e79fb0d93c23eb24de8c420dd8446))
* store plaintext username and password in auto-generated basic auth secret ([#208](https://github.com/SadeghHayeri/k8s-operator/issues/208)) ([179b4a6](https://github.com/SadeghHayeri/k8s-operator/commit/179b4a60b94cf2e7fae5ddb293c9bfcc534f40ea)), closes [#201](https://github.com/SadeghHayeri/k8s-operator/issues/201)
* suppress gosec false positive and handle existing releases ([aef5468](https://github.com/SadeghHayeri/k8s-operator/commit/aef5468b57b3e787b9dbff82470362f5918d4bd0))
* suppress gosec G101 false positive and handle existing releases ([182fafb](https://github.com/SadeghHayeri/k8s-operator/commit/182fafb026d7733b4f6c9c5e918366fab71da79c))
* sync fork with upstream in OperatorHub workflow and fix Helm chart versioning ([#61](https://github.com/SadeghHayeri/k8s-operator/issues/61)) ([31c61bd](https://github.com/SadeghHayeri/k8s-operator/commit/31c61bd35a2be6e1c89c6e4d66c555bd2f5aa110))
* sync Helm RBAC and add gateway.existingSecret ([#98](https://github.com/SadeghHayeri/k8s-operator/issues/98)) ([33dbc2c](https://github.com/SadeghHayeri/k8s-operator/commit/33dbc2c15344ef857ec8e5d70f15544f9f5a12a0))
* sync release-please manifest to v0.9.1 ([#72](https://github.com/SadeghHayeri/k8s-operator/issues/72)) ([88f50a9](https://github.com/SadeghHayeri/k8s-operator/commit/88f50a9a2492d20922d7dfe2781e1d8c0fcdb1dd))
* update banner alt text ([#38](https://github.com/SadeghHayeri/k8s-operator/issues/38)) ([d00dc23](https://github.com/SadeghHayeri/k8s-operator/commit/d00dc23516d79e6a95b6aeca9d5d29c1a777e0e6))
* Update Chart.yaml version/appVersion to match latest release v0.2.4 ([#26](https://github.com/SadeghHayeri/k8s-operator/issues/26)) ([c475ffc](https://github.com/SadeghHayeri/k8s-operator/commit/c475ffcd145b5109befb784a1a92672377be8936))
* Update copyright to 2026 OpenClaw.rocks ([bca1f0f](https://github.com/SadeghHayeri/k8s-operator/commit/bca1f0f626ebd8c7c1285882d20b87483380fba4))
* Update copyright to 2026 OpenClaw.rocks ([4d462f9](https://github.com/SadeghHayeri/k8s-operator/commit/4d462f97799865f48c13525074702f4b1163e54f))
* Update Go version to 1.24 for CI compatibility ([5c13d06](https://github.com/SadeghHayeri/k8s-operator/commit/5c13d068f3cba6d19609a3ea78b237d4b0b311ff))
* update OLM bundle CSV to v0.9.0 and fix spec.version replacement ([#62](https://github.com/SadeghHayeri/k8s-operator/issues/62)) ([d82821f](https://github.com/SadeghHayeri/k8s-operator/commit/d82821f22fb029d29d20b664abd02bad7b6c2cd9))
* use --head flag for cross-fork OperatorHub PR creation ([#55](https://github.com/SadeghHayeri/k8s-operator/issues/55)) ([568db8f](https://github.com/SadeghHayeri/k8s-operator/commit/568db8f170444ff015a7897c43161271c8903685))
* use copyFileSync instead of renameSync in merge mode init container ([#121](https://github.com/SadeghHayeri/k8s-operator/issues/121)) ([72bd962](https://github.com/SadeghHayeri/k8s-operator/commit/72bd962d492fdfd3ccc525523e3bb6f12de3ac70)), closes [#120](https://github.com/SadeghHayeri/k8s-operator/issues/120)
* Use correct GitHub org name (OpenClaw-rocks) in all references ([#20](https://github.com/SadeghHayeri/k8s-operator/issues/20)) ([c157899](https://github.com/SadeghHayeri/k8s-operator/commit/c1578998cb7bfb4824eae64ce390fba4e508e6ca))
* Use direct append instead of loop for image pull secrets ([187477c](https://github.com/SadeghHayeri/k8s-operator/commit/187477c3e205ddf332bd9f2831936d141b1e4088))
* Use Go 1.24 with goinstall mode for golangci-lint ([3dd40c8](https://github.com/SadeghHayeri/k8s-operator/commit/3dd40c8fc02e964c9edd98407ae44a7d94634b2b))
* Use govet enable list for shadow analyzer ([3f04b1b](https://github.com/SadeghHayeri/k8s-operator/commit/3f04b1bd705f33df5c438e3ae9b22fd5e2cd7975))
* Use lowercase image names for OCI registry compatibility ([2d3c87e](https://github.com/SadeghHayeri/k8s-operator/commit/2d3c87ea562800a98b5be6c63b71bafe1fbae1e8))
* Use lowercase owner name for Helm OCI registry ([67bc33e](https://github.com/SadeghHayeri/k8s-operator/commit/67bc33e503a6f1329908dd437731b3bf96be2ea5))
* use Node.js TCP connect for health probes instead of wget ([#215](https://github.com/SadeghHayeri/k8s-operator/issues/215)) ([ecb7474](https://github.com/SadeghHayeri/k8s-operator/commit/ecb7474c2ea40775b3a5df5f008b299d319f0d75))
* use PAT for release-please to trigger downstream workflows ([#45](https://github.com/SadeghHayeri/k8s-operator/issues/45)) ([21191ed](https://github.com/SadeghHayeri/k8s-operator/commit/21191ed3e29ff2d4aeb4c0aa269eca1fb7f6284a))
* use RELEASE_PLEASE_TOKEN for OperatorHub submission ([#50](https://github.com/SadeghHayeri/k8s-operator/issues/50)) ([470df59](https://github.com/SadeghHayeri/k8s-operator/commit/470df59a66e30f0a46c11c2a2bda83d15019ddd2))
* use server-side apply for CRD installation and update README ([#94](https://github.com/SadeghHayeri/k8s-operator/issues/94)) ([73b0677](https://github.com/SadeghHayeri/k8s-operator/commit/73b0677d577ada187af7298e0b685cf25161ba12))
* use shell-capable images for distroless init containers ([#108](https://github.com/SadeghHayeri/k8s-operator/issues/108)) ([2c87e68](https://github.com/SadeghHayeri/k8s-operator/commit/2c87e68e2e8b6bb94c95fb2ae751084843ecf2af))
* use single-quoted node -e argument in merge mode scripts ([#164](https://github.com/SadeghHayeri/k8s-operator/issues/164)) ([a661ed8](https://github.com/SadeghHayeri/k8s-operator/commit/a661ed8d7fbaa91bbedcd9a198dbe74d52c27444)), closes [#162](https://github.com/SadeghHayeri/k8s-operator/issues/162)
